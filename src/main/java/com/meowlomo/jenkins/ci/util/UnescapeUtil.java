...
public class UnescapeUtil {
	...
	// eg: String text = "saasa$(a)xxxxx$(b)"; Map<String, String> variables = new HashMap<String,String>();
	// variables.put("a", "35"); variables.put("b", "36");
	// with function handle,the result will return saasa35xxxxx36
